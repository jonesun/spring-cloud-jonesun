package org.jonesun.common.constant;
...
public interface AuthConstants {
     ...
     * 后台管理客户端ID
     */
    String ADMIN_CLIENT_ID = "jonesun-admin";


    /**
     * 微信小程序客户端ID
     */
    String WEAPP_CLIENT_ID = "jonesun-mall-weapp";
    ...
    String LOGOUT_PATH = "/jonesun-auth/oauth/logout";
